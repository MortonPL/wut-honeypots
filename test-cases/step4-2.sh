...
# "Upload" files using command-line HTTP clients

## wget

wget -O hello_wget.sh https://gist.githubusercontent.com/mob-sakai/174a32b95572e7d8fdbf8e6f43a528f6/raw/1dc49460272dd4399469b295b189a520beef02f8/hello.sh
